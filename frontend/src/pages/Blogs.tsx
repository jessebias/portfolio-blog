    ...
    return (
        <div className="selection:bg-[#666] selection:text-white">
            ...
            <div className="max-w-[1200px] mx-auto px-6 mb-32 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                {/* Article 1 */}
                <Link to="/blogs/living-design-systems-in-2026" className="bg-white/2 border border-white/8 rounded-xl overflow-hidden transition-all duration-300 ease-out hover:-translate-y-1 hover:bg-white/5 hover:border-[#666] flex flex-col h-full group">
                ...
                {/* Article 2 */}
                <Link to="/blogs/building-cyber-decks" className="bg-white/2 border border-white/8 rounded-xl overflow-hidden transition-all duration-300 ease-out hover:-translate-y-1 hover:bg-white/5 hover:border-[#666] flex flex-col h-full group">
                    <div className="w-full h-[200px] bg-[#111] flex items-center justify-center text-[#9B9B9B] text-xs border-b border-white/8">
                        [ IMG_PLACEHOLDER ]
                    </div>
                    <div className="p-6 flex flex-col grow">
                ...
                {/* Article 3 */}
                <Link to="/blogs/neural-link-integration" className="bg-white/2 border border-white/8 rounded-xl overflow-hidden transition-all duration-300 ease-out hover:-translate-y-1 hover:bg-white/5 hover:border-[#666] flex flex-col h-full group">
                    <div className="w-full h-[200px] bg-[#111] flex items-center justify-center text-[#9B9B9B] text-xs border-b border-white/8">
                        [ IMG_PLACEHOLDER ]
                    </div>
                    <div className="p-6 flex flex-col grow">
                ...
                {/* Article 4 */}
                <Link to="/blogs/the-agentic-workflow" className="bg-white/2 border border-white/8 rounded-xl overflow-hidden transition-all duration-300 ease-out hover:-translate-y-1 hover:bg-white/5 hover:border-[#666] flex flex-col h-full group">
                    <div className="w-full h-[200px] bg-[#111] flex items-center justify-center text-[#9B9B9B] text-xs border-b border-white/8">
                        [ IMG_PLACEHOLDER ]
                    </div>
                    <div className="p-6 flex flex-col grow">
